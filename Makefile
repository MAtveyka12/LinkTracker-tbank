...
.PHONY: build_bot
build_bot:
	@echo "A go build for the bot target is in progress"
	@mkdir -p .bin
	@go build -o ./bin/bot ./cmd/bot

.PHONY: build_scrapper
build_scrapper:
	@echo "A go build for the scrapper target is in progress"
	@mkdir -p .bin
...
.PHONY: run_scrapper
run_scrapper:
	@echo "Launching the scraper..."
	@go run ./cmd/scrapper/main.go

.PHONY: run
run:
	@echo "Launching a bot and scraper..."
	@bash -c "make run_bot & make run_scrapper & wait"
