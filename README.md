...
**LinkTracker** — это телеграм-бот и микросервис Scrapper для отслеживания изменений по ссылкам на GitHub-репозитории и вопросам Stack Overflow. Пользователь может добавлять ссылки для отслеживания, получать уведомления о новых коммитах, pull request'ах и ответах на вопросы.
